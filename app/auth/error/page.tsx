...
function AuthErrorContent() {
  ...
  const errorMessages: Record<string, { title: string; description: string }> = {
    ...
    branch_not_allowed: {
      ...
      description: "For Batch 2024, access is currently enabled only for CSE/DSE/EE/MEVLSI/MSE/BioE/CE/EP/GE/ME students. If you believe this is a mistake, please contact the administrator.",
    },
    Default: {
