        ...
        <section className="space-y-5">
          <section className="rounded-2xl border border-border bg-surface p-4 sm:p-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
              ...
              <Field label="Course level"><input type="number" min="0" max="20" value={courseForm.level} onChange={(e) => setCourseForm({ ...courseForm, level: e.target.value })} className={inputClass} /></Field>
