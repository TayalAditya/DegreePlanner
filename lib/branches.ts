...
export const BRANCH_CONFIGS: Record<string, BranchConfig> = {
  ...
  GE: {
    code: 'GE',
    name: 'General Engineering (Open Specialization)',
    fullName: 'B.Tech in General Engineering (Open Specialization)',
    type: 'BTech',
    totalCredits: 160,
    icCredits: 60,
    dcCredits: 36,
    // Open Specialisation merges the DE pool into Free Electives: DE 0 + FE 52.
    deCredits: 0,
    feCredits: 52,
    mtpIstpCredits: 12,
    minCreditsForMTP: 90,
  ...
  'GE-FIN': {
    code: 'GE-FIN',
    name: 'General Engineering (Fintech)',
    fullName: 'B.Tech in General Engineering – Fintech Specialization (under development)',
    type: 'BTech',
    totalCredits: 160,
    icCredits: 60,
    dcCredits: 36,
